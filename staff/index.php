...
<head>
  ...
  <script src="/js/bootstrap.min.js"></script>
	<script src="https://cloud.tinymce.com/stable/tinymce.min.js?apiKey=yxn851sw67jefbjya2ievcvaxtievc47bzxtit0922t9vuzh"></script>
...
<body class="bg-light">
	...
	<div class="d-flex" id="wrapper">
		...
		<div id="sidebar1">
			<script>
				(function() {
					var cx = '009001161380464907256:j2bdmobnrjy';
		...
		<!-- Page Content -->
		<div class="content p-4" id="content"></div>
	</div>
	<div id="footer1"></div>
</body>
</html>